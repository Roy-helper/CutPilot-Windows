"""PythonBridge API — exposed to JavaScript via pywebview.

Every public method on PythonBridge is callable from the Vue frontend
...
class PythonBridge:
    ...
    def export_logs(self) -> dict:
        ...
        try:
            ...
            shutil.copy2(str(self._log_file), str(dest))
